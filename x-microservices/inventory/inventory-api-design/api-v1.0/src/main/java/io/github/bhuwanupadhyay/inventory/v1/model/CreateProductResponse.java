...
/**
 * Once product created in inventory. The product id must be not null.
 */
@ApiModel(description = "Once product created in inventory. The product id must be not null.")
